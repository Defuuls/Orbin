...
**Codenames:** every milestone gets a codename drawn from the smallest known stars — Janus,
Fomalhaut C, EQ Pegasi A, CM Draconis A, and v35's Proxima Centauri (v34 took a detour as
"Dippin"). Pick names that are distinctive,

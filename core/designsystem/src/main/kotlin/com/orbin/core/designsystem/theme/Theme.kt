 ...
 *
 * On Android 12+ (`minSdk` 31) dynamic color is preferred when [dynamicColor] is on; otherwise
 * the static eggplant scheme applies. Imageboard skin [colorSchemeVariant]s apply only to the

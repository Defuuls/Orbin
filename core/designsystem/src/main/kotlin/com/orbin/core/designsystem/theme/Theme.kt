...
// Palette seeds for the ported imageboard skins. Held as private properties (rather than inline in
// the enum) so their hex color literals are treated as property declarations by static analysis.
...
/** Color scheme variant selection. Entries carrying [ChanThemeSeeds] are ported imageboard skins
 * (e.g. 8chan's themes); the rest use curated Material schemes. */

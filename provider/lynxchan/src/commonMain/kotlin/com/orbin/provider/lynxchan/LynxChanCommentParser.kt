...
import com.orbin.provider.api.MAX_CODE_POINT
import com.orbin.provider.api.SURROGATE_CODE_UNITS
import com.orbin.provider.api.UriParts
import com.orbin.provider.api.codePointToString
...
internal object LynxChanCommentParser {
    ...
    private fun sanitizeLinkHref(raw: String?): String? {
        ...
        val scheme = UriParts.parse(trimmed)?.scheme?.lowercase()
    ...
    private fun Int.isAllowedEntityCodePoint(): Boolean {
        ...
        val isVisibleScalar = this in MIN_VISIBLE_CODE_POINT..MAX_CODE_POINT && this !in SURROGATE_CODE_UNITS
